 ...
 **/
public class DeviceOrderedPlansRequest extends ThreeIdCombineDTO implements SimbossRequest{
  ...
  public Type getResponseType() {
    return new TypeToken<SimbossResponse<List<OrderedPlansDTO>>>() {}.getType();
  }
}
